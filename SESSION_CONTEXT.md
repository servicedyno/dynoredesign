...
### API Documentation
- Swagger UI: `https://env-manager-8.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://env-manager-8.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://env-manager-8.preview.emergentagent.com`
