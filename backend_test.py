...
Tests Phase 1 Database Schema Updates, Phase 2 Tax API Integration, and Phase 3 Dashboard APIs
"""
            ...
            with open('/app/frontend/.env', 'r') as f:
                for line in f:
                    if line.startswith('REACT_APP_BACKEND_URL='):
                        ...
                        # For testing Phase 3 Dashboard APIs, use localhost since external URL serves frontend
...
'''
    ...
    def run_all_tests(self):
        ...
        # Test 2: Phase 3 Dashboard API endpoints (NEW)
        self.test_dashboard_apis()
        
        # Test 3: Phase 2 Tax API endpoints (keeping existing tests)
        self.test_tax_api_endpoints()
        
        # Test 4: Verify tax cache in database
