...
- **SERVER_URL**: Updated to `https://multi-tenant-pay-1.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://multi-tenant-pay-1.preview.emergentagent.com`
