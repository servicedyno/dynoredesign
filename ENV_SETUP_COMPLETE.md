...
- **SERVER_URL**: Updated to `https://dependency-setup-4.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://dependency-setup-4.preview.emergentagent.com`
