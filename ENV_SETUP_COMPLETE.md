...
- **SERVER_URL**: Updated to `https://config-dependencies.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://config-dependencies.preview.emergentagent.com`
