...
- **SERVER_URL**: Updated to `https://crypto-sweep-retry.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://crypto-sweep-retry.preview.emergentagent.com`
