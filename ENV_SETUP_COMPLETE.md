...
- **SERVER_URL**: Updated to `https://server-manager-19.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://server-manager-19.preview.emergentagent.com`
