...
- **Previous URL**: https://multi-tenant-pay-1.preview.emergentagent.com
- **Current Development URL**: `https://multi-tenant-pay-1.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://multi-tenant-pay-1.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://multi-tenant-pay-1.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://multi-tenant-pay-1.preview.emergentagent.com/api`
