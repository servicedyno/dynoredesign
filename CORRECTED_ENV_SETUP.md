...
- **Previous URL**: https://config-dependencies.preview.emergentagent.com
- **Current Development URL**: `https://config-dependencies.preview.emergentagent.com`
...
SERVER_URL=https://config-dependencies.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://config-dependencies.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://config-dependencies.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://config-dependencies.preview.emergentagent.com/api`
