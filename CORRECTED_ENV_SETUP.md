...
- **Previous URL**: https://env-manager-8.preview.emergentagent.com
- **Current Development URL**: `https://env-manager-8.preview.emergentagent.com`
...
SERVER_URL=https://env-manager-8.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://env-manager-8.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://env-manager-8.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://env-manager-8.preview.emergentagent.com/api`
