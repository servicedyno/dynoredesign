...
- **Previous URL**: https://finance-backend-5.preview.emergentagent.com
- **Current Development URL**: `https://finance-backend-5.preview.emergentagent.com`
...
SERVER_URL=https://finance-backend-5.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://finance-backend-5.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://finance-backend-5.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://finance-backend-5.preview.emergentagent.com/api`
