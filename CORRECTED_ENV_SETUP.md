...
- **Previous URL**: https://dependinstall.preview.emergentagent.com
- **Current Development URL**: `https://dependinstall.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://dependinstall.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://dependinstall.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://dependinstall.preview.emergentagent.com/api`
