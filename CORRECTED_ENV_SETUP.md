...
- **Previous URL**: https://install-bundle.preview.emergentagent.com
- **Current Development URL**: `https://install-bundle.preview.emergentagent.com`
...
SERVER_URL=https://install-bundle.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://install-bundle.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://install-bundle.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://install-bundle.preview.emergentagent.com/api`
