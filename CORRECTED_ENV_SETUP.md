...
- **Previous URL**: https://install-deps-4.preview.emergentagent.com
- **Current Development URL**: `https://install-deps-4.preview.emergentagent.com`
...
SERVER_URL=https://install-deps-4.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://install-deps-4.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://install-deps-4.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://install-deps-4.preview.emergentagent.com/api`
