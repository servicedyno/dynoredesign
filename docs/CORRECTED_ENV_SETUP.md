...
- **Previous URL**: https://init-stack.preview.emergentagent.com
- **Current Development URL**: `https://init-stack.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://init-stack.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://init-stack.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://init-stack.preview.emergentagent.com/api`
