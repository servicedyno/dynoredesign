...
- **Previous URL**: https://gas-fee-alerts.preview.emergentagent.com
- **Current Development URL**: `https://gas-fee-alerts.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://gas-fee-alerts.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://gas-fee-alerts.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://gas-fee-alerts.preview.emergentagent.com/api`
