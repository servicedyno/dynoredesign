...
- **Previous URL**: https://install-manager-5.preview.emergentagent.com
- **Current Development URL**: `https://install-manager-5.preview.emergentagent.com`
...
- **Swagger Documentation**: `https://install-manager-5.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://install-manager-5.preview.emergentagent.com/api`
