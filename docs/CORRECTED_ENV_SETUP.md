...
- **Previous URL**: https://bootstrap-deps.preview.emergentagent.com
- **Current Development URL**: `https://bootstrap-deps.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://bootstrap-deps.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://bootstrap-deps.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://bootstrap-deps.preview.emergentagent.com/api`
