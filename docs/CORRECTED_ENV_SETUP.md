...
- **Previous URL**: https://test-suite-16.preview.emergentagent.com
- **Current Development URL**: `https://test-suite-16.preview.emergentagent.com`
...
SERVER_URL=https://test-suite-16.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://test-suite-16.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://test-suite-16.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://test-suite-16.preview.emergentagent.com/api`
