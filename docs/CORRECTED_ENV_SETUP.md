...
- **Previous URL**: https://packages-setup.preview.emergentagent.com
- **Current Development URL**: `https://packages-setup.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://packages-setup.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://packages-setup.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://packages-setup.preview.emergentagent.com/api`
