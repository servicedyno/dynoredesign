...
- **Previous URL**: https://install-hub-11.preview.emergentagent.com
- **Current Development URL**: `https://install-hub-11.preview.emergentagent.com`
...
SERVER_URL=https://install-hub-11.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://install-hub-11.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://install-hub-11.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://install-hub-11.preview.emergentagent.com/api`
