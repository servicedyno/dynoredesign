...
- **Previous URL**: https://payment-cache-test.preview.emergentagent.com
- **Current Development URL**: `https://payment-cache-test.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://payment-cache-test.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://payment-cache-test.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://payment-cache-test.preview.emergentagent.com/api`
