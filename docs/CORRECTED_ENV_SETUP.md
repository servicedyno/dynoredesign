...
- **Previous URL**: https://dep-manager-3.preview.emergentagent.com
- **Current Development URL**: `https://dep-manager-3.preview.emergentagent.com`
...
SERVER_URL=https://dep-manager-3.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://dep-manager-3.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://dep-manager-3.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://dep-manager-3.preview.emergentagent.com/api`
