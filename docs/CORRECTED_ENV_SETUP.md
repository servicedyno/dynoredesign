...
- **Previous URL**: https://pool-address-build.preview.emergentagent.com
- **Current Development URL**: `https://pool-address-build.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://pool-address-build.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://pool-address-build.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://pool-address-build.preview.emergentagent.com/api`
