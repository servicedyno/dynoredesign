...
- **Previous URL**: https://crypto-wallet-sync-2.preview.emergentagent.com
- **Current Development URL**: `https://crypto-wallet-sync-2.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://crypto-wallet-sync-2.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://crypto-wallet-sync-2.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://crypto-wallet-sync-2.preview.emergentagent.com/api`
