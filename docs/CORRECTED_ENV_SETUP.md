...
- **Previous URL**: https://api-payment-restore.preview.emergentagent.com
- **Current Development URL**: `https://api-payment-restore.preview.emergentagent.com`
...
SERVER_URL=https://api-payment-restore.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://api-payment-restore.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://api-payment-restore.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://api-payment-restore.preview.emergentagent.com/api`
