...
- **Previous URL**: https://anomaly-finder-10.preview.emergentagent.com
- **Current Development URL**: `https://anomaly-finder-10.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://anomaly-finder-10.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://anomaly-finder-10.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://anomaly-finder-10.preview.emergentagent.com/api`
