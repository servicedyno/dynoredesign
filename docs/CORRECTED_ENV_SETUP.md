...
- **Previous URL**: https://init-install.preview.emergentagent.com
- **Current Development URL**: `https://init-install.preview.emergentagent.com`
...
SERVER_URL=https://init-install.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://init-install.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://init-install.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://init-install.preview.emergentagent.com/api`
