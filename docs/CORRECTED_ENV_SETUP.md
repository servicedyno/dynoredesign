...
- **Previous URL**: https://dyno-crypto-pay.preview.emergentagent.com
- **Current Development URL**: `https://dyno-crypto-pay.preview.emergentagent.com`
...
SERVER_URL=https://dyno-crypto-pay.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://dyno-crypto-pay.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://dyno-crypto-pay.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://dyno-crypto-pay.preview.emergentagent.com/api`
