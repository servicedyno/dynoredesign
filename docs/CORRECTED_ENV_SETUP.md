...
- **Previous URL**: https://setup-deps-5.preview.emergentagent.com
- **Current Development URL**: `https://setup-deps-5.preview.emergentagent.com`
...
SERVER_URL=https://setup-deps-5.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://setup-deps-5.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://setup-deps-5.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://setup-deps-5.preview.emergentagent.com/api`
