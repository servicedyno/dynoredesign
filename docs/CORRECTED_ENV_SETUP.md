...
- **Previous URL**: https://code-analyzer-256.preview.emergentagent.com
- **Current Development URL**: `https://code-analyzer-256.preview.emergentagent.com`
...
SERVER_URL=https://code-analyzer-256.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://code-analyzer-256.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://code-analyzer-256.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://code-analyzer-256.preview.emergentagent.com/api`
