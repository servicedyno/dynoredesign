...
- **Previous URL**: https://dependency-setup-8.preview.emergentagent.com
- **Current Development URL**: `https://dependency-setup-8.preview.emergentagent.com`
...
```bash
REACT_APP_BACKEND_URL=https://dependency-setup-8.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://dependency-setup-8.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://dependency-setup-8.preview.emergentagent.com/api`
