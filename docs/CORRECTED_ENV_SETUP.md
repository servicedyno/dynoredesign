...
- **Previous URL**: https://dependency-manager-1.preview.emergentagent.com
- **Current Development URL**: `https://dependency-manager-1.preview.emergentagent.com`
...
SERVER_URL=https://dependency-manager-1.preview.emergentagent.com
...
```bash
REACT_APP_BACKEND_URL=https://dependency-manager-1.preview.emergentagent.com
WDS_SOCKET_PORT=443
...
- **Swagger Documentation**: `https://dependency-manager-1.preview.emergentagent.com/api/docs`
- **Base API URL**: `https://dependency-manager-1.preview.emergentagent.com/api`
