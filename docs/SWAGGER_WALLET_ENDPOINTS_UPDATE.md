...
### Check Swagger UI:
1. Visit: `https://rlusd-erc20-deploy.preview.emergentagent.com/api/docs`
...
```bash
curl -X GET "https://rlusd-erc20-deploy.preview.emergentagent.com/api/wallet/getWalletAddresses?company_id=38" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
