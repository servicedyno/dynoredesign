...
### Check Swagger UI:
1. Visit: `https://init-install-1.preview.emergentagent.com/api/docs`
...
```bash
curl -X GET "https://init-install-1.preview.emergentagent.com/api/wallet/getWalletAddresses?company_id=38" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
