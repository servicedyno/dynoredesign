...
- **SERVER_URL**: Updated to `https://blockchain-fee-check.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://blockchain-fee-check.preview.emergentagent.com`
