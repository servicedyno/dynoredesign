...
- **SERVER_URL**: Updated to `https://dep-installer-44.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://dep-installer-44.preview.emergentagent.com`
