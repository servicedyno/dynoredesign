...
- **SERVER_URL**: Updated to `https://trustline-install.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://trustline-install.preview.emergentagent.com`
