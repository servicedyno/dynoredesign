...
- **SERVER_URL**: Updated to `https://wallet-manager-33.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://wallet-manager-33.preview.emergentagent.com`
