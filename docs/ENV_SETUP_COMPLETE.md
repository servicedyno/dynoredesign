...
- **SERVER_URL**: Updated to `https://payment-guard-11.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://payment-guard-11.preview.emergentagent.com`
