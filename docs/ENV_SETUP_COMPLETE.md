...
- **SERVER_URL**: Updated to `https://api-payment-restore.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://api-payment-restore.preview.emergentagent.com`
