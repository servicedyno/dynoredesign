...
- **SERVER_URL**: Updated to `https://pool-address-build.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://pool-address-build.preview.emergentagent.com`
