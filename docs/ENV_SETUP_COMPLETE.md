...
- **SERVER_URL**: Updated to `https://dependency-installer-3.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://dependency-installer-3.preview.emergentagent.com`
