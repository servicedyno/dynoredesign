...
- **SERVER_URL**: Updated to `https://anomaly-finder-10.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://anomaly-finder-10.preview.emergentagent.com`
