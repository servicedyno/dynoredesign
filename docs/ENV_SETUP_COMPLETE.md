...
- **SERVER_URL**: Updated to `https://install-helper-26.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://install-helper-26.preview.emergentagent.com`
