...
- **SERVER_URL**: Updated to `https://rlusd-erc20-deploy.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://rlusd-erc20-deploy.preview.emergentagent.com`
