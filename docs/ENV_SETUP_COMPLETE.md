...
- **SERVER_URL**: Updated to `https://webhook-verification.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://webhook-verification.preview.emergentagent.com`
