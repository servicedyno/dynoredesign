...
- **SERVER_URL**: Updated to `https://dependency-manager-1.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://dependency-manager-1.preview.emergentagent.com`
