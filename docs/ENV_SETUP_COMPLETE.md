...
- **SERVER_URL**: Updated to `https://crypto-wallet-sync-2.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://crypto-wallet-sync-2.preview.emergentagent.com`
