...
- **SERVER_URL**: Updated to `https://code-analyzer-256.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://code-analyzer-256.preview.emergentagent.com`
