...
- **SERVER_URL**: Updated to `https://install-manager-5.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://install-manager-5.preview.emergentagent.com`
