...
- **SERVER_URL**: Updated to `https://dependency-hub-7.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://dependency-hub-7.preview.emergentagent.com`
