...
- **SERVER_URL**: Updated to `https://payment-cache-test.preview.emergentagent.com`
...
- **REACT_APP_BACKEND_URL**: Updated to `https://payment-cache-test.preview.emergentagent.com`
