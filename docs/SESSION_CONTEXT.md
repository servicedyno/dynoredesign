...
### API Documentation
- Swagger UI: `https://dependency-installer-3.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://dependency-installer-3.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://dependency-installer-3.preview.emergentagent.com`
