...
### API Documentation
- Swagger UI: `https://sweep-nonce-fix.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://sweep-nonce-fix.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://sweep-nonce-fix.preview.emergentagent.com`
