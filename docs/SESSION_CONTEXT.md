...
### API Documentation
- Swagger UI: `https://init-stack.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://init-stack.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://init-stack.preview.emergentagent.com`
