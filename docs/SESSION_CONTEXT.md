...
### API Documentation
- Swagger UI: `https://build-foundation-7.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://build-foundation-7.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://build-foundation-7.preview.emergentagent.com`
