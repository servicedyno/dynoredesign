...
### API Documentation
- Swagger UI: `https://gas-fee-alerts.preview.emergentagent.com/api/docs`
- OpenAPI Spec: `https://gas-fee-alerts.preview.emergentagent.com/api/docs.json`
...
### Environment URLs
- **Backend URL**: `https://gas-fee-alerts.preview.emergentagent.com`
