...
```bash
curl -X POST "https://webhook-verification.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://webhook-verification.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
curl -X POST "https://webhook-verification.preview.emergentagent.com/api/company/addCompany" \
...
https://webhook-verification.preview.emergentagent.com/api/docs
