...
```bash
curl -X POST "https://install-deps-8.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://install-deps-8.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://install-deps-8.preview.emergentagent.com/api/docs
...
curl -X POST "https://install-deps-8.preview.emergentagent.com/api/company/addCompany" \
...
https://install-deps-8.preview.emergentagent.com/api/docs
