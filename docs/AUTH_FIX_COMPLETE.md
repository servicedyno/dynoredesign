...
```bash
curl -X POST "https://api-payment-restore.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://api-payment-restore.preview.emergentagent.com/api/docs
...
curl -X POST "https://api-payment-restore.preview.emergentagent.com/api/company/addCompany" \
...
https://api-payment-restore.preview.emergentagent.com/api/docs
