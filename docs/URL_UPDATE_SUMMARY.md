...
**Key Changes:**
- **SERVER_URL**: `https://blockchain-fee-check.preview.emergentagent.com` (Current Development URL)
...
**Key Changes:**
- **REACT_APP_BACKEND_URL**: `https://blockchain-fee-check.preview.emergentagent.com` (Current Development URL)
...
- **Preview URL**: `https://blockchain-fee-check.preview.emergentagent.com`
