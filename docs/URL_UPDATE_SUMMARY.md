...
**Key Changes:**
- **SERVER_URL**: `https://bootstrap-deps.preview.emergentagent.com` (Current Development URL)
...
**Key Changes:**
- **REACT_APP_BACKEND_URL**: `https://bootstrap-deps.preview.emergentagent.com` (Current Development URL)
...
- **Preview URL**: `https://bootstrap-deps.preview.emergentagent.com`
