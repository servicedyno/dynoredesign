...
- ✅ External: `https://bootstrap-deps.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://bootstrap-deps.preview.emergentagent.com/
+ CHECKOUT_URL=https://bootstrap-deps.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://bootstrap-deps.preview.emergentagent.com/
├── FRONTEND_URL: https://bootstrap-deps.preview.emergentagent.com
