...
- ✅ External: `https://rlusd-xrpl-fix.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://rlusd-xrpl-fix.preview.emergentagent.com/
+ CHECKOUT_URL=https://rlusd-xrpl-fix.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://rlusd-xrpl-fix.preview.emergentagent.com/
├── FRONTEND_URL: https://rlusd-xrpl-fix.preview.emergentagent.com
