...
- ✅ External: `https://payment-cache-test.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://payment-cache-test.preview.emergentagent.com/
+ CHECKOUT_URL=https://payment-cache-test.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://payment-cache-test.preview.emergentagent.com/
├── FRONTEND_URL: https://payment-cache-test.preview.emergentagent.com
