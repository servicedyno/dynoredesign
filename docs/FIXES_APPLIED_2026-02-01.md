...
- ✅ External: `https://init-install.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://init-install.preview.emergentagent.com/
+ CHECKOUT_URL=https://init-install.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://init-install.preview.emergentagent.com/
├── FRONTEND_URL: https://init-install.preview.emergentagent.com
