...
- ✅ External: `https://eth-gas-debug.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://eth-gas-debug.preview.emergentagent.com/
+ CHECKOUT_URL=https://eth-gas-debug.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://eth-gas-debug.preview.emergentagent.com/
├── FRONTEND_URL: https://eth-gas-debug.preview.emergentagent.com
