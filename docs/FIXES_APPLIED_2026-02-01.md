...
- ✅ External: `https://init-stack.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://init-stack.preview.emergentagent.com/
+ CHECKOUT_URL=https://init-stack.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://init-stack.preview.emergentagent.com/
├── FRONTEND_URL: https://init-stack.preview.emergentagent.com
