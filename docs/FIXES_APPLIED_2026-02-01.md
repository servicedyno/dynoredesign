...
- ✅ External: `https://setup-deps-6.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://setup-deps-6.preview.emergentagent.com/
+ CHECKOUT_URL=https://setup-deps-6.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://setup-deps-6.preview.emergentagent.com/
├── FRONTEND_URL: https://setup-deps-6.preview.emergentagent.com
