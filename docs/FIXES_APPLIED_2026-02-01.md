...
- ✅ External: `https://gas-fee-alerts.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://gas-fee-alerts.preview.emergentagent.com/
+ CHECKOUT_URL=https://gas-fee-alerts.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://gas-fee-alerts.preview.emergentagent.com/
├── FRONTEND_URL: https://gas-fee-alerts.preview.emergentagent.com
