...
- ✅ External: `https://code-analyzer-256.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://code-analyzer-256.preview.emergentagent.com/
+ CHECKOUT_URL=https://code-analyzer-256.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://code-analyzer-256.preview.emergentagent.com/
├── FRONTEND_URL: https://code-analyzer-256.preview.emergentagent.com
