...
- ✅ External: `https://init-chain.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://init-chain.preview.emergentagent.com/
+ CHECKOUT_URL=https://init-chain.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://init-chain.preview.emergentagent.com/
├── FRONTEND_URL: https://init-chain.preview.emergentagent.com
