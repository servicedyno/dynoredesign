...
- ✅ External: `https://blockchain-fee-check.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://blockchain-fee-check.preview.emergentagent.com/
+ CHECKOUT_URL=https://blockchain-fee-check.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://blockchain-fee-check.preview.emergentagent.com/
├── FRONTEND_URL: https://blockchain-fee-check.preview.emergentagent.com
