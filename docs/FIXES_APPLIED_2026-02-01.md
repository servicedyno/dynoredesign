...
- ✅ External: `https://sweep-nonce-fix.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://sweep-nonce-fix.preview.emergentagent.com/
+ CHECKOUT_URL=https://sweep-nonce-fix.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://sweep-nonce-fix.preview.emergentagent.com/
├── FRONTEND_URL: https://sweep-nonce-fix.preview.emergentagent.com
