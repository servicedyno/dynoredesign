...
- ✅ External: `https://dependency-manager-1.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://dependency-manager-1.preview.emergentagent.com/
+ CHECKOUT_URL=https://dependency-manager-1.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://dependency-manager-1.preview.emergentagent.com/
├── FRONTEND_URL: https://dependency-manager-1.preview.emergentagent.com
