...
- ✅ External: `https://pool-address-build.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://pool-address-build.preview.emergentagent.com/
+ CHECKOUT_URL=https://pool-address-build.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://pool-address-build.preview.emergentagent.com/
├── FRONTEND_URL: https://pool-address-build.preview.emergentagent.com
