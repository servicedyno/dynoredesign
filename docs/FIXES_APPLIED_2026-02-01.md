...
- ✅ External: `https://wallet-manager-33.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://wallet-manager-33.preview.emergentagent.com/
+ CHECKOUT_URL=https://wallet-manager-33.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://wallet-manager-33.preview.emergentagent.com/
├── FRONTEND_URL: https://wallet-manager-33.preview.emergentagent.com
