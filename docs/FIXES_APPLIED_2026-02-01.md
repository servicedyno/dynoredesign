...
- ✅ External: `https://dep-init.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://dep-init.preview.emergentagent.com/
+ CHECKOUT_URL=https://dep-init.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://dep-init.preview.emergentagent.com/
├── FRONTEND_URL: https://dep-init.preview.emergentagent.com
