...
- ✅ External: `https://api-payment-restore.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://api-payment-restore.preview.emergentagent.com/
+ CHECKOUT_URL=https://api-payment-restore.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://api-payment-restore.preview.emergentagent.com/
├── FRONTEND_URL: https://api-payment-restore.preview.emergentagent.com
