...
- ✅ External: `https://install-helper-26.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://install-helper-26.preview.emergentagent.com/
+ CHECKOUT_URL=https://install-helper-26.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://install-helper-26.preview.emergentagent.com/
├── FRONTEND_URL: https://install-helper-26.preview.emergentagent.com
