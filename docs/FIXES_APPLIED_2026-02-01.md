...
- ✅ External: `https://init-install-1.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://init-install-1.preview.emergentagent.com/
+ CHECKOUT_URL=https://init-install-1.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://init-install-1.preview.emergentagent.com/
├── FRONTEND_URL: https://init-install-1.preview.emergentagent.com
