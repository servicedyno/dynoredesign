...
- ✅ External: `https://setup-tooling.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://setup-tooling.preview.emergentagent.com/
+ CHECKOUT_URL=https://setup-tooling.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://setup-tooling.preview.emergentagent.com/
├── FRONTEND_URL: https://setup-tooling.preview.emergentagent.com
