...
- ✅ External: `https://setup-wizard-84.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://setup-wizard-84.preview.emergentagent.com/
+ CHECKOUT_URL=https://setup-wizard-84.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://setup-wizard-84.preview.emergentagent.com/
├── FRONTEND_URL: https://setup-wizard-84.preview.emergentagent.com
