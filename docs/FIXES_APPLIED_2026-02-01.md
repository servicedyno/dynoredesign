...
- ✅ External: `https://init-project-9.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://init-project-9.preview.emergentagent.com/
+ CHECKOUT_URL=https://init-project-9.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://init-project-9.preview.emergentagent.com/
├── FRONTEND_URL: https://init-project-9.preview.emergentagent.com
