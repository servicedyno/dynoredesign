...
- ✅ External: `https://payment-guard-11.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://payment-guard-11.preview.emergentagent.com/
+ CHECKOUT_URL=https://payment-guard-11.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://payment-guard-11.preview.emergentagent.com/
├── FRONTEND_URL: https://payment-guard-11.preview.emergentagent.com
