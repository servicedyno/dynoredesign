...
- ✅ External: `https://install-deps-8.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://install-deps-8.preview.emergentagent.com/
+ CHECKOUT_URL=https://install-deps-8.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://install-deps-8.preview.emergentagent.com/
├── FRONTEND_URL: https://install-deps-8.preview.emergentagent.com
