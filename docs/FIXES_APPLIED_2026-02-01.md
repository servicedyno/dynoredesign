...
- ✅ External: `https://dependency-setup-8.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://dependency-setup-8.preview.emergentagent.com/
+ CHECKOUT_URL=https://dependency-setup-8.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://dependency-setup-8.preview.emergentagent.com/
├── FRONTEND_URL: https://dependency-setup-8.preview.emergentagent.com
