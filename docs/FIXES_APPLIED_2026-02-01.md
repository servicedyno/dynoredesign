...
- ✅ External: `https://dependency-prep.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://dependency-prep.preview.emergentagent.com/
+ CHECKOUT_URL=https://dependency-prep.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://dependency-prep.preview.emergentagent.com/
├── FRONTEND_URL: https://dependency-prep.preview.emergentagent.com
