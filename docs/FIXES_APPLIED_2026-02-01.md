...
- ✅ External: `https://test-suite-16.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://test-suite-16.preview.emergentagent.com/
+ CHECKOUT_URL=https://test-suite-16.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://test-suite-16.preview.emergentagent.com/
├── FRONTEND_URL: https://test-suite-16.preview.emergentagent.com
