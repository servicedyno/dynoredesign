...
- ✅ External: `https://rlusd-erc20-deploy.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://rlusd-erc20-deploy.preview.emergentagent.com/
+ CHECKOUT_URL=https://rlusd-erc20-deploy.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://rlusd-erc20-deploy.preview.emergentagent.com/
├── FRONTEND_URL: https://rlusd-erc20-deploy.preview.emergentagent.com
