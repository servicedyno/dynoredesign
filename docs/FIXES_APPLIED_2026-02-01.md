...
- ✅ External: `https://install-flow-2.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://install-flow-2.preview.emergentagent.com/
+ CHECKOUT_URL=https://install-flow-2.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://install-flow-2.preview.emergentagent.com/
├── FRONTEND_URL: https://install-flow-2.preview.emergentagent.com
