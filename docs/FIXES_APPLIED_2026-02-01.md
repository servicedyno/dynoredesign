...
- ✅ External: `https://setup-dependencies-3.preview.emergentagent.com/api/` - Working
...
**Changes:**
```diff
- CHECKOUT_URL=https://setup-dependencies-3.preview.emergentagent.com/
+ CHECKOUT_URL=https://setup-dependencies-3.preview.emergentagent.com/
```
...
├── CHECKOUT_URL: https://setup-dependencies-3.preview.emergentagent.com/
├── FRONTEND_URL: https://setup-dependencies-3.preview.emergentagent.com
