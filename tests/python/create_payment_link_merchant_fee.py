...
BASE_URL = "https://dependency-installer-4.preview.emergentagent.com/api"
...
# Create payment link with MERCHANT paying fees
print("\n2. Creating $10 payment link (MERCHANT pays fees)...")
payment_data = {
    "email": "customer2@example.com",
    "amount": 10,
    "base_currency": "USD",
    "modes": ["CRYPTO"],
    "description": "Test Payment - $10 USD (Merchant Pays Fees)",
    "expire": "7d",
    "fee_payer": "merchant",  # Changed from "customer" to "merchant"
    "company_id": 38
}
...
if payment_response.status_code == 200:
    ...
    print(f"   Fee Payer: {data.get('fee_payer', 'N/A')} 👈 MERCHANT PAYS FEES")
    ...
    payment_id = data.get('link_id') or data.get('payment_id') or data.get('id')
