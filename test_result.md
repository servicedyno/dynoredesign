backend:
  - target_url: https://first-steps-120.preview.emergentagent.com/api
  - test_endpoints:
...
frontend:
  - target_url: https://first-steps-120.preview.emergentagent.com
  - test_pages:
    - / (Landing/Home page)
...
- test_results: MIXED RESULTS ⚠️
  * Target URL https://first-steps-120.preview.emergentagent.com/api → HTTP 404 (Service not available at this URL)
  * Current URL https://first-steps-120.preview.emergentagent.com/api → ALL TESTS PASSED ✅
...
- target_url: https://first-steps-120.preview.emergentagent.com/documentation
