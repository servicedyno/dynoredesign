...
- **Frontend** (`/app/.env.local`): `NEXT_PUBLIC_BASE_URL=https://6e7bd34c-a2a2-4629-b5d5-e62405341470.preview.emergentagent.com/` (trailing slash for axios `api/` concatenation)
...
backend:
  - task: "Create Payment Link - Minimal Fields (amount + currency only)"
    ...
    status_history:
      ...
      - working: true
        agent: "testing"
        comment: "✅ PASSED: Minimal fields test successful. API returns 200 status with valid payment_link URL containing correct pod URL (https://pod-integration-flow.preview.emergentagent.com). Response includes all expected fields: link_id, transaction_id, base_amount=10, base_currency=USD, fee_payer=company, description=null."
...
- `/app/.env.local`: `NEXT_PUBLIC_BASE_URL=https://pod-integration-flow.preview.emergentagent.com/`
- `/app/frontend/.env`: `REACT_APP_BACKEND_URL=https://pod-integration-flow.preview.emergentagent.com`
- `/app/backend/.env`: `SERVER_URL`, `CHECKOUT_URL`, `FRONTEND_URL` all set to `https://pod-integration-flow.preview.emergentagent.com`
...
- Set all env files to current pod URL `6e7bd34c-a2a2-4629-b5d5-e62405341470`
- `/app/.env.local`: `NEXT_PUBLIC_BASE_URL=https://6e7bd34c-a2a2-4629-b5d5-e62405341470.preview.emergentagent.com/`
- `/app/frontend/.env`: `REACT_APP_BACKEND_URL=https://6e7bd34c-a2a2-4629-b5d5-e62405341470.preview.emergentagent.com`
- `/app/backend/.env`: `SERVER_URL`, `CHECKOUT_URL`, `FRONTEND_URL` all set to `https://6e7bd34c-a2a2-4629-b5d5-e62405341470.preview.emergentagent.com`
