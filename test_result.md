...
frontend:
  - target_url: https://onboard-flow-79.preview.emergentagent.com
...
- test_results: MIXED RESULTS ⚠️
  * Target URL https://onboard-flow-79.preview.emergentagent.com/api → HTTP 404 (Service not available at this URL)
  * Current URL https://onboard-flow-79.preview.emergentagent.com/api → ALL TESTS PASSED ✅
