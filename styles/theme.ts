...
export const lightTheme = createTheme({
  ...
  palette: {
    mode: "light",
    common: { black: "#12131C", white: "#fff" },
    primary: { main: "#12131C", dark: "#000000", light: "#383943", contrastText: "#fff" },
    secondary: { main: "#1034A6", dark: "#001076", light: "#585ed8" },
    text: { primary: "#12131C", secondary: "#1034A6" },
    background: { default: "#F5F8FF", paper: "#FFFFFF" },
    surface: { main: "#F5F8FF", paper: "#FFFFFF", border: "#E7EAFD" },
  },
...
export const darkTheme = createTheme({
  ...
  palette: {
    mode: "dark",
    common: { black: "#12131C", white: "#fff" },
    primary: { main: "#FFFFFF", dark: "#E0E0E0", light: "#FFFFFF", contrastText: "#12131C" },
