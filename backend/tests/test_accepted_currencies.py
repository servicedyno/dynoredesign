...
class TestAcceptedCurrencies:
    """Test suite for accepted currencies feature"""
    
    auth_token = None
    created_link_ids = []  # Track created links for cleanup
    
    @pytest.fixture(autouse=True)
    def setup(self, request):
        """Setup: authenticate before tests"""
        if TestAcceptedCurrencies.auth_token is None:
            self._authenticate()
        yield
        # Cleanup after all tests in class
        if request.node.name == list(request.session.items)[-1].name:
            self._cleanup_test_links()
    ...
    def _get_headers(self):
        ...
        return {
            ...
            "Authorization": f"Bearer {TestAcceptedCurrencies.auth_token}"
        }
    
    def _cleanup_test_links(self):
        """Cleanup created test links"""
        for link_id in TestAcceptedCurrencies.created_link_ids:
            try:
                requests.delete(
    ...
    # ==========================================
    def test_get_company_currencies_success(self):
    ...
    def test_get_company_currencies_invalid_company(self):
    ...
    # ==========================================
    def test_create_payment_link_with_accepted_currencies(self):
        ...
        # Track for cleanup
        TestAcceptedCurrencies.created_link_ids.append(result['link_id'])
    ...
    def test_create_payment_link_without_accepted_currencies(self):
    ...
    def test_create_payment_link_invalid_crypto_type(self):
    ...
    def test_create_payment_link_unconfigured_wallet(self):
    ...
    # ==========================================
    def test_get_payment_link_returns_accepted_currencies(self):
        ...
        TestAcceptedCurrencies.created_link_ids.append(link_id)
    ...
    # ==========================================
    def test_update_payment_link_accepted_currencies(self):
    ...
    def test_update_payment_link_clear_accepted_currencies(self):
    ...
    def test_update_payment_link_invalid_crypto(self):
    ...
    def test_update_payment_link_unconfigured_wallet(self):
