...
- Checkout URL: https://install-setup-4.preview.emergentagent.com
...
# Configuration
BACKEND_URL = "https://setup-deps-3.preview.emergentagent.com"
CHECKOUT_URL = "https://install-setup-4.preview.emergentagent.com"
    ...
    def test_scenario_6_payment_distribution_logic(self):
        ...
        try:
            ...
            if response_company.status_code == 200:
                ...
                payment_ref_company = link_data_company.get("payment_reference")
