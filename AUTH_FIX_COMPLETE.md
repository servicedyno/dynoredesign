...
```bash
curl -X POST "https://f5006fc4-5cad-480e-8552-90fd171f8760.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://f5006fc4-5cad-480e-8552-90fd171f8760.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://f5006fc4-5cad-480e-8552-90fd171f8760.preview.emergentagent.com/api/docs
...
curl -X POST "https://f5006fc4-5cad-480e-8552-90fd171f8760.preview.emergentagent.com/api/company/addCompany" \
...
https://f5006fc4-5cad-480e-8552-90fd171f8760.preview.emergentagent.com/api/docs
