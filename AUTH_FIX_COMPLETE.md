...
```bash
curl -X POST "https://setup-wizard-77.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://setup-wizard-77.preview.emergentagent.com/api/docs
...
curl -X POST "https://setup-wizard-77.preview.emergentagent.com/api/company/addCompany" \
...
https://setup-wizard-77.preview.emergentagent.com/api/docs
