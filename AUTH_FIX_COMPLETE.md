...
```bash
curl -X POST "https://payunstuck.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://payunstuck.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://payunstuck.preview.emergentagent.com/api/docs
...
curl -X POST "https://payunstuck.preview.emergentagent.com/api/company/addCompany" \
...
https://payunstuck.preview.emergentagent.com/api/docs
