...
```bash
curl -X POST "https://project-setup-33.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://project-setup-33.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://project-setup-33.preview.emergentagent.com/api/docs
...
curl -X POST "https://project-setup-33.preview.emergentagent.com/api/company/addCompany" \
...
https://project-setup-33.preview.emergentagent.com/api/docs
