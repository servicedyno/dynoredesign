...
```bash
curl -X POST "https://setup-hub-3.preview.emergentagent.com/api/user/registerUser" \
...
```bash
curl -X POST "https://setup-hub-3.preview.emergentagent.com/api/user/login" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "your@email.com",
    "password": "YourPassword123"
...
1. **Open Swagger**: https://setup-hub-3.preview.emergentagent.com/api/docs
...
curl -X POST "https://setup-hub-3.preview.emergentagent.com/api/company/addCompany" \
...
https://setup-hub-3.preview.emergentagent.com/api/docs
